...
function getContactsQuality(contacts: number): { label: string; color: string } {
  ...
  if (contacts >= 1000) return { label: 'Moderate', color: 'text-muted-foreground' };
...
function getHbondsQuality(hbonds: number): { label: string; color: string } {
  ...
  if (hbonds >= 5) return { label: 'Moderate', color: 'text-muted-foreground' };
  return { label: 'Low', color: 'text-red-600' };
}
...
function getPerplexityQuality(perplexity: number): { label: string; color: string } {
  ...
  if (perplexity < 12.0) return { label: 'Moderate', color: 'text-muted-foreground' };
...
function getPackstatQuality(packstat: number): { label: string; color: string } {
  ...
  if (packstat >= 0.4) return { label: 'Moderate', color: 'text-muted-foreground' };
  return { label: 'Poor', color: 'text-red-600' };
}
...
function getSCQuality(sc: number): { label: string; color: string } {
  ...
  if (sc >= 0.4) return { label: 'Moderate', color: 'text-muted-foreground' };
  return { label: 'Poor', color: 'text-red-600' };
}
...
function getHydrophobicityQuality(hydrophobicity: number): { label: string; color: string } {
  ...
  if (hydrophobicity < 0.50) return { label: 'Moderate', color: 'text-muted-foreground' };
...
function getPlddtQuality(plddt: number): { label: string; color: string } {
  ...
  if (plddt >= 0.5) return { label: 'Low', color: 'text-muted-foreground' };
    ...
    <div className="bg-card rounded-xl border border-border overflow-hidden">
      ...
      <div className="bg-muted px-4 py-3 border-b border-border">
        <div className="flex items-center gap-2">
          ...
          <h4 className="font-semibold text-foreground text-sm">Interface Quality</h4>
        </div>
      ...
      <div className="p-4 grid grid-cols-2 gap-4">
        ...
        <div className="bg-muted/50 rounded-lg p-3">
          <div className="flex items-center gap-2 mb-2">
            ...
            <span className="text-xs text-muted-foreground uppercase tracking-wide">H-Bonds</span>
          </div>
          <div className="text-2xl font-bold text-foreground">
        ...
        <div className="bg-muted/50 rounded-lg p-3">
          <div className="flex items-center gap-2 mb-2">
            ...
            <span className="text-xs text-muted-foreground uppercase tracking-wide">Buried SASA</span>
          </div>
          <div className="text-2xl font-bold text-foreground">
            {metrics.buried_sasa.toFixed(1)}
            <span className="text-sm font-normal text-muted-foreground ml-1">Å²</span>
          </div>
        ...
        <div className="bg-muted/50 rounded-lg p-3">
          <div className="flex items-center gap-2 mb-2">
            ...
            <span className="text-xs text-muted-foreground uppercase tracking-wide">Packstat</span>
          </div>
          <div className="text-2xl font-bold text-foreground">
          ...
          <div className="bg-muted rounded-lg p-3 border border-border">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              {metrics.shape_complementarity != null && (
                <div>
                  <div className="text-xs text-muted-foreground mb-1">Shape Complementarity</div>
              ...
              {metrics.surface_hydrophobicity != null && (
                <div>
                  <div className="text-xs text-muted-foreground mb-1">Surface Hydrophobicity</div>
                  <div className="text-xl font-bold text-foreground">
              ...
              {metrics.unsaturated_hbonds != null && (
                <div>
                  <div className="text-xs text-muted-foreground mb-1">Unsat. H-bonds</div>
                  <div className="text-xl font-bold text-foreground">
                    {metrics.unsaturated_hbonds}
                  </div>
                  <div className={`text-xs font-medium ${metrics.unsaturated_hbonds <= 6 ? 'text-green-600' : 'text-muted-foreground'}`}>
              ...
              {metrics.interface_residue_count != null && (
                <div>
                  <div className="text-xs text-muted-foreground mb-1">Interface Residues</div>
                  <div className="text-xl font-bold text-foreground">
                    {metrics.interface_residue_count}
                  </div>
                  <div className={`text-xs font-medium ${metrics.interface_residue_count >= 6 ? 'text-green-600' : 'text-muted-foreground'}`}>
        ...
        <div className="px-4 pb-4">
          <div className="bg-muted rounded-lg p-4 border border-border">
            ...
            <div className="grid grid-cols-5 gap-2 mb-4">
              {/* H-bonds */}
              <div className="text-center p-2 bg-card/60 rounded-lg">
              ...
              <div className="text-center p-2 bg-card/60 rounded-lg">
                ...
                <div className="text-xs text-muted-foreground">Pi-Stack</div>
              </div>
              ...
              <div className="text-center p-2 bg-card/60 rounded-lg">
                ...
                <div className="text-xs text-muted-foreground">Salt Bridges</div>
              </div>

              {/* Total */}
              <div className="text-center p-2 bg-card/60 rounded-lg border-2 border-blue-200">
                <div className="text-xl font-bold text-foreground">
                  {interactions.total}
                </div>
            ...
            {interactions.halogen_bonds !== undefined && interactions.halogen_bonds > 0 && (
              <div className="mb-3 text-center p-2 bg-card/60 rounded-lg">
            ...
            {key_binding_residues && key_binding_residues.length > 0 && (
              <div>
                <div className="text-xs text-muted-foreground mb-2">Key Binding Residues:</div>
                <div className="flex flex-wrap gap-1">
                  {key_binding_residues.slice(0, 10).map((residue, idx) => (
                    <span
                      key={idx}
                      className="px-2 py-0.5 bg-card/80 text-xs font-mono text-foreground rounded border border-border"
                    >
                      {residue}
                    </span>
                  ))}
          ...
          <div className={`rounded-lg p-3 border ${
            ...
            <div className="flex items-center gap-2 mb-3">
              ...
              <span className={`text-xs font-medium uppercase tracking-wide ${
                esmfold.validation_passed ? 'text-green-700' : 'text-muted-foreground'
              }`}>
            ...
            <div className="grid grid-cols-2 gap-4">
              {/* pLDDT */}
              <div>
                <div className="text-xs text-muted-foreground mb-1">pLDDT Score</div>
                <div className="text-xl font-bold text-foreground">
              ...
              {esmfold.rmsd != null && (
                <div>
                  <div className="text-xs text-muted-foreground mb-1">Backbone RMSD</div>
                  <div className="text-xl font-bold text-foreground">
                  ...
                  <div className={`text-xs font-medium ${
                    ...
                    esmfold.rmsd <= 2.0 ? 'text-blue-600' : 'text-muted-foreground'
                  }`}>
        ...
        <div className="px-4 pb-4">
          <div className="bg-muted rounded-lg p-3 border border-border">
            ...
            <div className="grid grid-cols-2 gap-4">
              {/* Perplexity */}
              <div>
                <div className="text-xs text-muted-foreground mb-1">Perplexity</div>
                <div className="text-xl font-bold text-foreground">
