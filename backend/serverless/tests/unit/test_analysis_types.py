...
def test_detect_design_type_ligand_dimer():
    ...
    assert dtype == StructureType.LIGAND_INTERFACE_DIMER
...
def test_detect_design_type_metal_dimer():
    ...
    assert dtype == StructureType.METAL_INTERFACE_DIMER
...
def test_detect_design_type_metal_ligand_dimer():
    ...
    assert dtype == StructureType.METAL_LIGAND_INTERFACE_DIMER
...
def test_detect_design_type_monomer():
    ...
    assert dtype == StructureType.MONOMER
