...
# design_validation_pipeline (MPNN + ESMFold) — imported lazily by handlers/analysis.py
...
try:
    ...
    GEOMETRY_VALIDATION_AVAILABLE = True
except ImportError as e:
    GEOMETRY_VALIDATION_AVAILABLE = False
...
def _design_metal_ligand_joint(
    ...
    for design_idx in range(num_designs):
        ...
        if GEOMETRY_VALIDATION_AVAILABLE and complex_info:
            try:
